...
def start(conf, data, model, evaluate, dir):
    ...
    t0 = time()
    d_train.initializeRankingTrain()  # 生成hash_data, positive_data, negative_data, 下面同理
    ...
    data_dict = d_train.prepareModelSupplement(model)  # 生成consumeItemList和socialNeighborList
    ...
    for epoch in range(1, conf.epochs+1):
        ...
        negative_predictions = getNegativePredictions()  # 10622 * 1000   这个去重了所以少了
